...
new const String:g_weaponList[NUMBER_OF_WEAPONS][] = // Weapon names.
...
g_runSpeeds[NUMBER_OF_WEAPONS] = // Max movement speed of weapons (respective to g_weaponList array.
